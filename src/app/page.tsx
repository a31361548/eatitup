...
export default async function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-aether-dark px-4 py-16 text-aether-cyan">
      {/* Structured Grid Background */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(94,234,212,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(94,234,212,0.03)_1px,transparent_1px)] bg-[size:40px_40px] pointer-events-none" />
      <div className="absolute inset-0 bg-gradient-to-b from-aether-dark via-transparent to-aether-dark pointer-events-none" />
      ...
      <section className="relative z-10 flex w-full max-w-5xl flex-col items-center gap-12">
        ...
        <div className="w-full max-w-md relative group">
            ...
            <div className="relative bg-aether-dark/80 border border-aether-cyan/30 backdrop-blur-md rounded-lg p-1 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
